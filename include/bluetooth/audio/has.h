...
struct bt_has_preset_ops {
	 ...
	 * @param idx	Preset index requested to activate,
	 ...
	 */
	int (*active_set)(struct bt_has *has, uint8_t idx, bool sync);
	 ...
	 *
	 * @param has	Pointer to the Hearing Access Service object.
	 * @param idx	Preset index that name changed.
	 * @param name	Preset current name.
	 */
	void (*name_changed)(struct bt_has *has, uint8_t idx, const char *name);
};
 ...
 */
int bt_has_preset_name_set(struct bt_has *has, uint8_t idx, const char *name);
 ...
 * @return 0 in case of success or negative value in case of error.
 */
int bt_has_preset_active_set(struct bt_has *has, uint8_t idx);
 ...
 * @return 0 in case of success or negative value in case of error.
 */
int bt_has_preset_visibility_set(struct bt_has *has, uint8_t idx, bool visible);
 ...
 * @return 0 in case of success or negative value in case of error.
 */
int bt_has_preset_availability_set(struct bt_has *has, uint8_t idx, bool available);
 ...
 *
 * @param has	Pointer to the Hearing Access Service object.
 * @param idx	Index of preset to read.
 *
 * @return 0 in case of success or negative value in case of error.
 */
int bt_has_preset_read(struct bt_has *has, uint8_t idx);
 ...
 *
 * @param has		Pointer to the Hearing Access Service object.
 * @param start_idx	The index to start with.
...
struct bt_has_client_cb {
	 ...
	 */
	void (*discover)(struct bt_conn *conn, struct bt_has *has, uint8_t type);
	 ...
	 * @param idx	Active preset index.
	 */
	void (*active_preset)(struct bt_has *has, int err, uint8_t idx);
	 ...
	 */
	void (*preset)(struct bt_has *has, int err, uint8_t idx, uint8_t properties,
		       const char *name);
	 ...
	 * @param idx		Preset index.
	 */
	void (*preset_deleted)(struct bt_has *has, uint8_t idx);
	 ...
	 */
	void (*preset_availibility)(struct bt_has *has, uint8_t idx, bool available);
