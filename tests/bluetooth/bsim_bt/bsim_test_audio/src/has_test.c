...
BT_HAS_PRESET_DEFINE(g_universal_idx, "Universal", BT_HAS_PROP_WRITABLE | BT_HAS_PROP_AVAILABLE);
BT_HAS_PRESET_DEFINE(g_outdoor_idx, "Outdoor", BT_HAS_PROP_WRITABLE | BT_HAS_PROP_AVAILABLE);
BT_HAS_PRESET_DEFINE(g_noisy_idx, "Noisy environment",
		     BT_HAS_PROP_WRITABLE | BT_HAS_PROP_AVAILABLE);
BT_HAS_PRESET_DEFINE(g_office_idx, "Office", BT_HAS_PROP_WRITABLE | BT_HAS_PROP_AVAILABLE);
